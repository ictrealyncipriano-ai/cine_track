...
$countStmt = $pdo->prepare('SELECT COUNT(*) as total FROM activity_feed WHERE user_id = ?');
$countStmt->execute([$profileId]);
$total = (int) $countStmt->fetch()['total'];

$stmt = $pdo->prepare("
    SELECT a.id, a.action_type, a.target_type, a.target_id, a.metadata, a.created_at,
