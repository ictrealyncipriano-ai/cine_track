...
$pdo = getDb();
$stmt = $pdo->prepare('
    INSERT INTO favorites (user_id, movie_id, title, overview, poster_path, backdrop_path, release_date, vote_average)
    VALUES (?, ?, ?, ?, ?, ?, ?, ?)
...
logActivity($userId, 'favorited', 'movie', (int) $input['movie_id']);
